# Worker Brief — AEF Setup on /opt/832-Workflow-designer

You are an autonomous worker spawned from the framework repo
(`/opt/999-Agentic-Engineering-Framework`, task T-2202) to set up the
Agentic Engineering Framework (AEF) in `/opt/832-Workflow-designer` and bring
it to a clean, verified state.

Your cwd is `/opt/832-Workflow-designer`. **Stay inside this directory tree.**
Do not edit, inspect, or write paths outside `/opt/832-Workflow-designer`
...
/opt/832-Workflow-designer** with the proposed framework improvement. Tag it
