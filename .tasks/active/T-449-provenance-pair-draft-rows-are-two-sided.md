---
id: T-449
name: "PROVENANCE pair-draft rows are two-sided at last: AEF's records land, dispatch-loop's arc ref is wrong, and the two sides define pair-draft differently"
description: >
