...
bvp_scores_proposed:
  ...
  - ts: '2026-09-26T09:06:27Z'
    ...
    scores:
      ...
      F1: 1
    rationale: 'D1=4 (body:structural-gate); D2=4 (body:fw-audit-or-doctor); D3=4
      (body:framework-level-ux); D4=2 (body:env-class-handled); F-RECALL=2 (body:lightly-promoted);
      F2=0 (no-signal); F4=0 (L0: no signal); F3=0 (L0: no signal); F1=1 (L1:keyword=designer,L1:keyword=bpmn)'
    rubric_sha: e4a00f38e801
cost_estimate_proposed:
  ...
  - ts: '2026-09-21T20:24:52Z'
    ...
    rationale: blast_radius=3 
      (paths:.agentic-framework/agents/audit/audit.sh,docs/reports/T-723-review-queue-residue.md,tools/_t723-review-queue-residue.py);
