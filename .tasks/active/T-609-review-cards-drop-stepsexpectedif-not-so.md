...
last_update: 2026-08-27T07:01:04Z
date_finished: null
...
- [ ] Writer identified. **NOT MET — left open deliberately.** Four candidates are
      excluded; the writer is not yet named. A background session started 9h ago on this
      machine is a plausible source that cannot be attributed from here. Recording this as
      unmet rather than closing the task on a partial explanation.
