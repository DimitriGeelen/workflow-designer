...
bvp_scores_proposed:
  ...
  - ts: '2026-09-26T09:06:21Z'
    ...
    scores:
      ...
      F1: 2
    rationale: 'D1=4 (body:structural-gate); D2=4 (body:fw-audit-or-doctor); D3=2
      (body:default-change); D4=2 (body:env-class-handled); F-RECALL=3 (body:fw-recall-or-memory-link);
      F2=1 (body/components:component-fabric-incidental); F4=0 (L0: no signal); F3=0
      (L0: no signal); F1=2 (L1:keyword=designer,L2:keyword=editor)'
    rubric_sha: e4a00f38e801
