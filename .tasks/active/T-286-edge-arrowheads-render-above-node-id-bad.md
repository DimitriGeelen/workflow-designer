---
id: T-286
name: "Edge arrowheads render above node-id badges; selected element's badge comes
  to foreground"
description: >
...
bvp_scores_proposed:
  ...
  - ts: '2026-09-26T09:06:20Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=2 
      (body:default-change); D4=2 (body:env-class-handled); F-RECALL=0 
      (no-signal); F2=0 (no-signal); F4=2 (L1:keyword=lane,L2:keyword=routing); 
      F3=4 (L4:keyword=round-trip); F1=2 (L1:keyword=designer,L2:keyword=canvas)
    rubric_sha: e4a00f38e801
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:12Z'
    ...
    rationale: blast_radius=3 
      (paths:src/aef-workflow-designer.html,tests/check-corpus-geometry.sh,tests/run-bridge-tests.sh);
