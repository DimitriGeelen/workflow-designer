...
description: >
  Vertical lane-header text longer than the lane height overlaps neighbouring lane headers (context-memory: 'COMPLETED HISTORIES · EPISODIC MEMORY' in a 160px lane). Truncate with ellipsis to fit laneHeight, full name via <title> tooltip. From context-memory evaluation 2026-07-04.
