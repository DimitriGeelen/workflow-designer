---
id: T-277
name: "Ratify process-level conformance key and stateKind carrier convention (AEF
  T-2652)"
description: >
  Inception: Ratify process-level conformance key and stateKind carrier convention
  (AEF T-2652)
...
revisit_evidence_needed: "AEF pings the T-2652 thread with a GO for in-map declaration (their slice 5)"
...
- [ ] [REVIEW] Review exploration findings and approve go/no-go decision
  **Steps:**
  1. Run: `fw task review T-277` (opens Watchtower with recommendation, assumptions, research artifacts)
