---
id: T-746
name: "RA-037: task file T-741 has no Updates section"
description: >
...
```
[WARN] Task T-741-vendored-tree-omits-tools-entirely--5-ve.md missing Updates section
```

### The invariant that is not held

The task template guarantees that every task carries an `## Updates` section, auto-populated by git mining at completion. T-741 has no such section, so the completion path has nowhere to write its provenance — the mining step will either no-op silently or append to the wrong place.
...
<!-- Filled at completion of inception tasks via:
     fw inception decide T-746 go|no-go|defer --rationale "..."
...
### 2026-09-21T07:58:45Z — task-created [task-create-agent]
