...
tags: [bug]
components:
  # Factual declaration of what this task touches, not a score input I chose for effect:
  # the probe being repaired, and the module whose renamed attribute broke it. The cost
  # estimator reports blast_radius=None until this is resolved (its own note points at
  # T-3068), which leaves the task without a quadrant and therefore unselectable.
  - tools/_t542-cost-blast-radius-teeth.py
