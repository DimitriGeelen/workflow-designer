---
id: T-447
name: "bake-clean-layout reports success on an empty corpus: --check prints '0/0 maps are a Clean fixpoint' and exits 0 over a denominator it never asserts (title corrected — the original named T-101 as the caller; measured, T-101 does not invoke it and nothing does, see T-448)"
description: >
  bake-clean-layout reports success on an empty corpus: --check prints '0/0 maps are a Clean fixpoint' and exits 0 over a denominator it never asserts (title corrected — the original named T-101 as the caller; measured, T-101 does not invoke it and nothing does, see T-448)
...
last_update: 2026-08-12T09:24:23Z
date_finished: null
