...
description: >
  S5b: render /api/list ghosts[] as visually-distinct GHOST cards in the gallery index.
  UI slice — needs visual verification; assess build-vs-inception scope before starting.
  Split from S5 (sibling S5a=T-232). Depends on S3 ghosts[] + S4 claim.
...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T14:32:59Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=2 
      ...
      F3=4 (prose:seam-fixture-or-pin); F1=4 (prose:process-named-workflow)
    rubric_sha: e4a00f38e801
