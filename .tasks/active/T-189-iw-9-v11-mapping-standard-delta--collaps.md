---
id: T-189
name: "IW-9: v1.1 mapping-standard delta — collapse triple-encoded authority (Lane=who,
  workflow_type=kind, remove node owner-override)"
description: >
  AEF IW-9 design finding (T-2523). Node-level owner duplicates the lane; collapse
  to two orthogonal axes. v1.1 delta to FROZEN v1 mapping standard — needs operator
  sign-off. Agent can draft the delta on GO.
...
bvp_scores_proposed:
  - ts: '2026-09-26T09:06:19Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=2 
      ...
      (body/components:component-fabric-incidental); F4=2 
      (L1:keyword=lane,L1:keyword=pool); F3=3 
      (L2:keyword=aef-bpmn,L2:keyword=forward-compile); F1=3 
      (L1:keyword=designer,L1:keyword=bpmn)
...
confirmed_at: '2026-09-25T22:30:54Z'
---
