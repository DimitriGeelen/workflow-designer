...
description: >
  Survey finding R-5 (docs/reports/T-041-routing-readability-survey.md): node badges and edge labels collide with edge channels in dense areas. Detect label/edge overlap on the rendered polylines and nudge labels to free space. Render-only.
...
last_update: 2026-07-04T11:09:39Z
...
### Human
- [ ] [REVIEW] Relocated labels read naturally on the live gallery
  **Steps:**
