...
description: >
  Save to project on the untouched starter seed silently creates an investigate version
  entry (self-inflicted residue source, see T-140). Add a confirm() guard in saveToProject:
  if the bytes to save equal the pristine seed BPMN, ask before writing. Self-contained;
  does not touch T-127 autosave.
...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T14:33:15Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=0 (no-signal); 
      ...
      F4=0 (no-signal); F3=1 (prose:AEF seam-incidental); F1=2 
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:17Z'
    ...
    rationale: blast_radius=3 
      (paths:build/gallery/designer.html,src/aef-workflow-designer.html,tools/serve-gallery.sh);
...
### Human
- [x] [REVIEW] The guard feels right — an unedited starter map warns before saving, a real
