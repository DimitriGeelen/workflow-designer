---
id: T-218
name: "Off-page connector (link-event) pairing in AEF-captured processes — understand
  the gap"
description: >
  Inception: Off-page connector (link-event) pairing in AEF-captured processes — understand
  the gap
