---
id: T-734
name: "NEW SCOPE: absence claimed from a truncated search — guard the Arc-0 evidence
  base against the defect that produced OBS-352 and OBS-353"
description: >
  NEW SCOPE: absence claimed from a truncated search — guard the Arc-0 evidence base
  against the defect that produced OBS-352 and OBS-353
