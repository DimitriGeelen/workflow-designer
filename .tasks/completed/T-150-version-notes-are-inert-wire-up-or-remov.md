...
description: >
  T-146 finding F4: saveToProject hardcodes note:'' so version notes are never stored; openVersionsModal renders e.note but it is always empty. Decide: wire up a note input on save, or remove the inert note-display. One deliverable.
...
last_update: 2026-07-09T12:27:01Z
