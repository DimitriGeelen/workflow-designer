---
id: T-427
name: "T-421 provenance collapses re-vendor imports into authored: any line arriving
  via a bulk vendor bump is reported as our own drift"
description: >
  T-421 provenance collapses re-vendor imports into authored: any line arriving via
  a bulk vendor bump is reported as our own drift
...
horizon:
tags: []
components: [tools/_t421-drift-mutation-check.sh, 
