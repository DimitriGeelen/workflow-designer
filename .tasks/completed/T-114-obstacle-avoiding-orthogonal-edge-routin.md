...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T14:33:13Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=0 (no-signal); 
      D4=3 (body:portability-abstraction); F-RECALL=2 (body:lightly-promoted); 
      F2=1 (body/components:component-fabric-incidental); F4=3 
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:16Z'
    ...
    rationale: blast_radius=5 
      (paths:build/gallery/designer.html,docs/reports/T-112-node-cut-router-inception.md,src/aef-workflow-designer.html,tests/check-corpus-node-cuts.sh);
...
### Human
- [x] [REVIEW] Rerouted fan/join edges look clean, not contorted
  **Steps:**
