---
id: T-463
name: "The register's own schema check has been red since G-029 was registered, and
  the one measurement that would have caught it was taken on a file that does not
  exist"
description: >
  The register's own schema check has been red since it shipped, and the one measurement
  that would have caught it was taken on a file that does not exist
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:23Z'
    ...
    rationale: blast_radius=5 
      (paths:.context/project/concerns.yaml,tools/_t350-teeth.sh,tools/_t352-p011-errexit-probe.sh,tools/concerns-schema.py);
