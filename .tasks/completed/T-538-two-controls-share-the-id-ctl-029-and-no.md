...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:25Z'
    ...
    rationale: blast_radius=5 
      (paths:.context/project/concerns.yaml,tests/run-bridge-tests.sh,tools/_t352-p011-errexit-probe.sh,tools/_t538-control-id-collision.py);
  ...
  - ts: '2026-08-16T13:58:58Z'
    ...
    rationale: blast_radius=3 
      (paths:.context/project/concerns.yaml,tests/run-bridge-tests.sh,tools/_t538-control-id-collision.py);
      tier=2 (no-signal); effort=8 (no-signal)
    rubric_sha: e4a00f38e801
---
