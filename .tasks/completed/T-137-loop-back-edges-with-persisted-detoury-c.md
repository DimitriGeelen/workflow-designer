...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:16Z'
    ...
    rationale: blast_radius=5 
      (paths:build/gallery/designer.html,src/aef-workflow-designer.html,tests/check-corpus-node-cuts.sh,tests/fixtures/valid/investigate.bpmn);
...
### Human
- [x] [REVIEW] At a gateway→node loop-back you couldn't straighten before, selecting the edge
