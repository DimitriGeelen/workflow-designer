...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:19Z'
    ...
    rationale: blast_radius=5 
      (paths:build/gallery/designer.html,dist/aef-workflow-designer-0.3.0.html,src/aef-workflow-designer.html,tests/fixtures/aef-bpmn/typed-events.bpmn);
...
- [x] Announce on the rail when landed (rides the 0.3.1 tag with T-234) — with the fix commit and what AEF should re-verify on their aef-dispatch-loop map (rail offset 156: commit dd8ce64, release-lineage root cause, both secondary fixes, post-re-pin re-verify steps, typed-throw contract offer)
...
### 2026-07-22T11:02:00Z — status-update [task-update-agent]
