---
id: T-228
name: "S4a: off-page claim UX — editor 'create from pending ref' picker (name-match
  suggest-only)"
description: >
  S4a: editor 'create from pending ref' picker — seeds a new map adopting a pending
  ghost's uuid; saving claims it (via:ui). CLI split to S4b/T-230.
...
- **Scan ID:** R-f67b96a6
- **Timestamp:** 2026-09-01T19:38:13Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none
...
### 2026-09-01T19:38:11Z — status-update [task-update-agent]
