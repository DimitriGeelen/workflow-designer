...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:17Z'
    ...
    rationale: blast_radius=5 
      (paths:docs/reports/T-142-in-editor-open-from-project-browser.md,tools/_gallery-list-verify.py,tools/_gallery-save-allowlist-verify.py,tools/gallery-serve.py);
