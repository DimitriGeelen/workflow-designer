...
description: >
  Net-new maps created via the + button (createNewWorkflow) emit workflowMeta without
  a uuid; mint only fires on the import/load path (line 8007). A map born in the S1
  editor must carry identity from birth. Found by AEF S4 e2e (rail offset 139).
...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T14:33:21Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=0 (no-signal); 
      D4=2 (body:env-class-handled); F-RECALL=3 (body:fw-recall-or-memory-link);
      F2=0 (no-signal); F4=0 (no-signal); F3=4 (prose:seam-fixture-or-pin); F1=2
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:19Z'
    ...
    rationale: blast_radius=3 
      (paths:src/aef-workflow-designer.html,tools/_gallery-list-verify.py,tools/_gallery-registry-verify.py);
