...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T14:33:26Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=0 (no-signal); 
      ...
      F4=1 (prose:routing/geometry-incidental); F3=5 (prose:seam-contract); F1=1
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:20Z'
    ...
    rationale: blast_radius=7 
      (paths:tests/fixtures/aef-bpmn/inception-gonogo.bpmn,tests/fixtures/aef-bpmn/two-lane-joint.bpmn,tests/run-bridge-tests.sh,tests/run-validator-tests.sh);
