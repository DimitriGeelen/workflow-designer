...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:19Z'
    ...
    rationale: blast_radius=5 
      (paths:scripts/release-designer.sh,tests/test_roundtrip_serialization.py,tests/test_t258_annotation_seam.py,tests/test_t259_eventdef_preservation.py);
...
### Human
- [x] [REVIEW] Badge look-and-feel reads right
  **Steps:**
