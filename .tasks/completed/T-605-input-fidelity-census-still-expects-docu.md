---
id: T-605
name: "Input-fidelity census still expects documentation to be dropped, so T-602's
  fix leaves a red driver"
description: >
  Input-fidelity census still expects documentation to be dropped, so T-602's fix
  leaves a red driver
