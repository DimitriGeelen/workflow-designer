---
id: T-226
name: "S3 /api/list uuid + ghosts[] extension + registry twin (.context/designer/registry.yaml)
  with 3 ghost-drop rules (T-218 GO slice 3)"
description: >
  S3 /api/list uuid + ghosts[] extension + registry twin (.context/designer/registry.yaml)
  with 3 ghost-drop rules (T-218 GO slice 3)
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:19Z'
    ...
    rationale: blast_radius=5 
      (paths:.context/designer/registry.yaml,docs/plans/T-220-offpage-seam-editor-build-decomposition.md,tests/test_corpus_fixture_pins.py,tools/_gallery-list-verify.py);
