---
id: T-551
name: "the instrument sweep discards every probe's output, so a reproduction of the
  intermittent-failure class yields an integer and nothing else"
description: >
  the instrument sweep discards every probe's output, so a reproduction of the intermittent-failure
  class yields an integer and nothing else
...
horizon:
tags: []
components: [tools/_t551-sweep-capture-teeth.py]
related_tasks: []
...
date_finished: 2026-08-16T20:42:59Z
...
- **Scan ID:** R-2cbef817
- **Timestamp:** 2026-08-16T20:43:10Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none

### 2026-08-16T20:42:59Z — status-update [task-update-agent]
