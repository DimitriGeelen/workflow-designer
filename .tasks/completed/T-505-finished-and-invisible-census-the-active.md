---
id: T-505
name: "Finished and invisible: census the active tasks whose ACs are all ticked but
  which never transitioned"
description: >
  Finished and invisible: census the active tasks whose ACs are all ticked but which
  never transitioned
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:24Z'
    ...
    rationale: blast_radius=5 
      (paths:tests/run-bridge-tests.sh,tools/_t352-p011-errexit-probe.sh,tools/_t451-unwired-guard-census.py,tools/_t505-finished-invisible-census.py);
  ...
  - ts: '2026-08-16T13:58:57Z'
    ...
    rationale: blast_radius=3 
      (paths:tests/run-bridge-tests.sh,tools/_t451-unwired-guard-census.py,tools/_t505-finished-invisible-census.py);
      tier=2 (no-signal); effort=8 (no-signal)
    rubric_sha: e4a00f38e801
---
