---
id: T-168
name: "Connection-point anchoring: attach edges to a node's individual ports (default
  center)"
description: >
  Connect and edge-reconnect default to node center (as now) but allow attaching to
  a specific perimeter connection point (port).
...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T14:33:17Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=3 
      (body:component-discoverability); D4=3 (body:portability-abstraction); 
      F-RECALL=0 (no-signal); F2=0 (no-signal); F4=2 
      (prose:routing-single-element); F3=2 (prose:seam-namespace); F1=0 
      (no-signal)
    rubric_sha: e4a00f38e801
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:17Z'
    ...
    rationale: blast_radius=3 
      (paths:build/gallery/designer.html,src/aef-workflow-designer.html,tools/gallery-serve.py);
...
### Human
- [x] [REVIEW] Connect-to-port feels natural and the default is unchanged
  **Steps:**
