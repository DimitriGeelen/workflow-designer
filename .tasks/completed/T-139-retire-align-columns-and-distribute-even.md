---
id: T-139
name: "Retire Align-columns and Distribute-evenly toolbar buttons (keep Clean + all
  functions)"
description: >
...
date_finished: 2026-07-07T14:43:00Z
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:17Z'
    ...
    rationale: blast_radius=5 
      (paths:build/gallery/designer.html,src/aef-workflow-designer.html,tests/check-corpus-node-cuts.sh,tools/_undo-verify-cdp.mjs);
...
### Human
- [x] [REVIEW] Toolbar reads clean with only Clean layout remaining; Clean still tidies + aligns columns
  **Steps:**
