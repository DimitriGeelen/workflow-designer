---
id: T-689
name: "Arc-2 isolation proof measures execution and secret but never ledger — one
  of the three authorities the roadmap column names"
description: >
  Arc-2 isolation proof measures execution and secret but never ledger — one of the
  three authorities the roadmap column names
