...
last_update: '2026-08-16T14:33:36Z'
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:23Z'
    ...
    rationale: blast_radius=5 
      (paths:.tasks/completed/T-361-exported-bytes-assert-aef-generates-di-f.md,docs/reports/T-357-di-adoption.md,src/aef-workflow-designer.html,tools/_t352-p011-errexit-probe.sh);
  ...
  - ts: '2026-08-16T13:58:55Z'
    ...
    rationale: blast_radius=3 
      (paths:.tasks/completed/T-361-exported-bytes-assert-aef-generates-di-f.md,docs/reports/T-357-di-adoption.md,src/aef-workflow-designer.html);
      tier=2 (no-signal); effort=8 (no-signal)
    rubric_sha: e4a00f38e801
---
