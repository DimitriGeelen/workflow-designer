---
id: T-648
name: "the other two fragment assertions still use the substring scan, and are weaker
  than the one T-645 fixed"
description: >
  the other two fragment assertions still use the substring scan, and are weaker than
  the one T-645 fixed
...
cost_estimate_proposed:
  - ts: '2026-09-21T20:25:08Z'
    ...
    rationale: blast_radius=3 
      (paths:.agentic-framework/web/conftest.py,.agentic-framework/web/test_app.py,.agentic-framework/web/test_costs.py);
