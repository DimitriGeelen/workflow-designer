...
description: >
  check-active-task.sh build-readiness gate blocks fw task update --type inception,
  the very command it prints as the unblock, because the task is still a placeholder
  build task. Fix: exempt type-conversion commands from the gate.
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:17Z'
    ...
    rationale: blast_radius=3 
      (paths:.agentic-framework/agents/context/check-active-task.sh,src/aef-workflow-designer.html);
