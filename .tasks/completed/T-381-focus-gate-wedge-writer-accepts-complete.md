...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:22Z'
    ...
    rationale: blast_radius=5 
      (paths:.context/working/focus.yaml,tools/_t352-p011-errexit-probe.sh,tools/_t381-focus-gate-wedge.sh,tools/validate-workflow.py);
  ...
  - ts: '2026-08-16T13:58:54Z'
    ...
    rationale: blast_radius=3 
      (paths:.context/working/focus.yaml,tools/_t381-focus-gate-wedge.sh); 
      tier=2 (no-signal); effort=8 (no-signal)
    rubric_sha: e4a00f38e801
---
