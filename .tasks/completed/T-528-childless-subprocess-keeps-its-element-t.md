---
id: T-528
name: "childless subProcess keeps its element type and extensionElements across a
  round-trip (AEF rail 11926 third arm)"
description: >
  childless subProcess keeps its element type and extensionElements across a round-trip
  (AEF rail 11926 third arm)
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:25Z'
    ...
    rationale: blast_radius=5 
      (paths:tools/_t352-p011-errexit-probe.sh,tools/_t451-unwired-guard-census.py,tools/_t523-nesting-teeth.py,tools/_t523-subprocess-nesting.mjs);
  ...
  - ts: '2026-08-16T13:58:58Z'
    ...
    rationale: blast_radius=3 
      (paths:tools/_t451-unwired-guard-census.py,tools/_t523-nesting-teeth.py,tools/_t523-subprocess-nesting.mjs);
      tier=2 (no-signal); effort=8 (no-signal)
    rubric_sha: e4a00f38e801
---
