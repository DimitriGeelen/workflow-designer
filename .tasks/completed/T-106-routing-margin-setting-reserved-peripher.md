...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T14:33:13Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=0 (no-signal); 
      D4=3 (body:portability-abstraction); F-RECALL=2 (body:lightly-promoted); 
      F2=1 (body/components:component-fabric-incidental); F4=4 
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:16Z'
    ...
    rationale: blast_radius=5 
      (paths:build/gallery/designer.html,docs/reports/T-092-routing-layout-survey.md,src/aef-workflow-designer.html,tools/serve-gallery.sh);
