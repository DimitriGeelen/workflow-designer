---
id: T-497
name: "measure the shell half of the derived-root harness population (T-496 stated
  hole)"
description: >
...
date_finished: 2026-08-14T08:31:29Z
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:24Z'
    ...
    rationale: blast_radius=5 
      (paths:tests/run-bridge-tests.sh,tools/_t352-p011-errexit-probe.sh,tools/_t429-zero-leg-probe.sh,tools/_t497-census-controls.sh);
...
- **Scan ID:** R-ab024d45
- **Timestamp:** 2026-08-14T08:33:09Z
- **Catalogue:** v1.3-seed
- **Overall:** CONCERN
- **Needs Human:** no
- **Findings:** 2
...
**Verification-level findings:**
  ...
  1. **empty-output-success** (partial, heuristic) @ Verification:line 43
     - evidence: `python3 tools/_t497-derived-root-census.py > /dev/null`
  2. **empty-output-success** (partial, heuristic) @ Verification:line 47
     - evidence: `bash tools/_t497-census-controls.sh > /dev/null`

### 2026-08-14T08:31:29Z — status-update [task-update-agent]
