...
description: >
  ...
  (10) which the editor writes to <aef:meta> (buildBpmnXml line ~4273) and shows in
  the node inspector. So YAML->bridge->editor drops them. Same coverage class as T-059
  but meta-attribute mechanism. Fix: align bridge META_KEYS with editor meta-writer
  keys; extend coverage test to assert meta-field parity. Discovered during T-059.
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:15Z'
    ...
    rationale: blast_radius=5 
      (paths:examples/aef-processes/task-gate.workflow.yaml,src/aef-workflow-designer.html,tests/run-bridge-tests.sh,tests/test_editor_bridge_meta_parity.py);
