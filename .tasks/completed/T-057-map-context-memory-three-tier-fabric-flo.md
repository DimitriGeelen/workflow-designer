---
id: T-057
name: "Map context-memory three-tier fabric flow"
description: >
  Diagram working (reset on init) / project (patterns+decisions+learnings) / episodic
  (gen on completion); init->focus->add-*->generate-episodic. agents/context/AGENT.md.
  Dogfood gap (T-054).
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:15Z'
    ...
    rationale: blast_radius=5 
      (paths:.agentic-framework/agents/context/context.sh,docs/reports/T-057-context-memory-friction.md,examples/aef-processes/context-memory.workflow.yaml,tests/run-bridge-tests.sh);
