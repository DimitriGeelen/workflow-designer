---
id: T-557
name: "fw note swallows an unrecognised subcommand as the observation text: 11 observations
  destroyed since 2026-08-09"
description: >
  fw note swallows an unrecognised subcommand as the observation text: 11 observations
  destroyed since 2026-08-09
...
date_finished: 2026-08-17T14:27:11Z
...
cost_estimate_proposed:
  - ts: '2026-09-21T20:25:07Z'
    ...
    rationale: blast_radius=5 
      (paths:.agentic-framework/agents/observe/observe.sh,.context/inbox.yaml,tests/run-bridge-tests.sh,tests/test_note_capture_refuses_lost_payload.py);
...
- **Scan ID:** R-a1f2a4a4
- **Timestamp:** 2026-08-17T14:27:13Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none

### 2026-08-17T14:27:11Z — status-update [task-update-agent]
