---
id: T-634
name: "AEF's toothless-guard defect is NOT present here, and the reason is errexit
  rather than the idiom — pin the dependency that makes it true"
description: >
  AEF's toothless-guard defect is NOT present here, and the reason is errexit rather
  than the idiom — pin the dependency that makes it true
...
cost_estimate_proposed:
  - ts: '2026-09-21T20:25:08Z'
    ...
    rationale: blast_radius=1 
      (paths:tools/_t634-guard-verdict-reaches-caller.sh); tier=2 (no-signal); 
      effort=8 (no-signal)
