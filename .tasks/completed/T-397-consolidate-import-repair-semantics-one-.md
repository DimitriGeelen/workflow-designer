...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:22Z'
    ...
    rationale: blast_radius=5 
      (paths:docs/reports/T-397-import-repair-semantics-brief.md,src/aef-workflow-designer.html,tools/_t352-p011-errexit-probe.sh,tools/validate-workflow.py);
  ...
  - ts: '2026-08-16T13:58:54Z'
    ...
    rationale: blast_radius=3 
      (paths:docs/reports/T-397-import-repair-semantics-brief.md,src/aef-workflow-designer.html);
      tier=3 (no-signal); effort=8 (no-signal)
    rubric_sha: e4a00f38e801
---
