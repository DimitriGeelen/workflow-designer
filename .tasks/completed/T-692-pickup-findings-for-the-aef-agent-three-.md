---
id: T-692
name: "Pickup findings for the AEF agent: three P-002/check-active-task defects measured
  in generic framework code"
description: >
  Pickup findings for the AEF agent: three P-002/check-active-task defects measured
  in generic framework code
...
cost_estimate_proposed:
  - ts: '2026-09-21T20:25:09Z'
    ...
    rationale: blast_radius=5 
      (paths:.agentic-framework/agents/context/budget-gate.sh,.agentic-framework/agents/context/check-active-task.sh,.agentic-framework/agents/task-create/update-task.sh,docs/reports/framework-agent-pickup-2026-09-09.md);
