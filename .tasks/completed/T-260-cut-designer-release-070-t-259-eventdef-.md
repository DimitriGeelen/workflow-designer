...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:19Z'
    ...
    rationale: blast_radius=3 
      (paths:dist/MANIFEST.yaml,docs/aef-designer-integration-protocol.md,scripts/release-designer.sh);
...
Operator-authorized release cut bundling T-259 (eventDef preservation) + T-258
(annotation seam v0) + first structured MANIFEST capabilities block. Protocol:
docs/aef-designer-integration-protocol.md.

## Acceptance Criteria

### Agent
- [x] VERSION bumped 0.6.0 → 0.7.0; scripts/release-designer.sh run clean
      (immutability guard green — 0.6.0 and earlier artifacts byte-untouched;
...
### 2026-07-27T19:11:11Z — task-created [task-create-agent]
- **Action:** Created task via task-create agent
- **Output:** /opt/832-Workflow-designer/.tasks/active/T-260-cut-designer-release-070-t-259-eventdef-.md
