---
id: T-658
name: "P-011 reports a killed verification command as a plain FAIL — 'did not finish'
  reads as 'your check is wrong'"
description: >
  P-011 reports a killed verification command as a plain FAIL — 'did not finish' reads
  as 'your check is wrong'
