---
id: T-415
name: "Probe the ANNOUNCED span rule against AEF's second-qualifier-occurrence case
  (rail 506 §4)"
description: >
  Probe the ANNOUNCED span rule against AEF's second-qualifier-occurrence case (rail
  506 §4)
...
date_finished: 2026-08-09T15:34:20Z
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:22Z'
    ...
    rationale: blast_radius=3 
      (paths:tools/_t352-p011-errexit-probe.sh,tools/tracked-secret-artifacts.py,tools/validate-workflow.py);
  ...
  - ts: '2026-08-16T13:58:55Z'
    ...
    cost_estimate:
      ...
      effort: 8
      blast_radius: 1
    rationale: blast_radius=1 (paths:tools/tracked-secret-artifacts.py); tier=1 
...
- **Scan ID:** R-017cec51
- **Timestamp:** 2026-08-09T15:34:20Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none

### 2026-08-09T15:34:20Z — status-update [task-update-agent]
