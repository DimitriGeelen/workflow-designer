---
id: T-666
name: "A dead control and an honest abstention both exit 2, so the sweep tells the
  reader to trust a dead instrument"
description: >
  A dead control and an honest abstention both exit 2, so the sweep tells the reader
  to trust a dead instrument
...
cost_estimate_proposed:
  - ts: '2026-09-21T20:25:09Z'
    ...
    rationale: blast_radius=7 
      (paths:tools/_t358-teeth.py,tools/_t364-t308-teeth.py,tools/_t364-tie-guard-teeth.py,tools/_t366-uid-shape-teeth.py);
