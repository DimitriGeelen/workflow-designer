---
id: T-536
name: "Tasks in .tasks/completed/ whose frontmatter still says started-work (CTL-028),
  surfaced 263 times in a corpus nothing reads"
description: >
  Tasks in .tasks/completed/ whose frontmatter still says started-work (CTL-028),
  surfaced 263 times in a corpus nothing reads
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:25Z'
    ...
    rationale: blast_radius=5 
      (paths:.context/project/concerns.yaml,.tasks/completed/T-338-input-fidelity-guard-prove-load-save-pre.md,tests/run-bridge-tests.sh,tools/_t352-p011-errexit-probe.sh);
