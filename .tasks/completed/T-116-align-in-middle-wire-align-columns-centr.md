...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T14:33:13Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=0 (no-signal); 
      ...
      F4=3 (prose:routing-defect-class); F3=0 (no-signal); F1=0 (no-signal)
    rubric_sha: e4a00f38e801
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:16Z'
    ...
    rationale: blast_radius=5 
      (paths:build/gallery/designer.html,src/aef-workflow-designer.html,tests/check-corpus-node-cuts.sh,tools/serve-gallery.sh);
