---
id: T-461
name: "Register the instrument-substitution class: agent shell grep is a ugrep shim,
  every gate runs GNU grep"
description: >
  Register the instrument-substitution class: agent shell grep is a ugrep shim, every
  gate runs GNU grep
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:23Z'
    ...
    rationale: blast_radius=5 
      (paths:.context/project/concerns.yaml,tools/_t352-p011-errexit-probe.sh,tools/concerns-schema.py,tools/validate-workflow.py);
  ...
  - ts: '2026-08-16T13:58:56Z'
    ...
    rationale: blast_radius=3 
      (paths:.context/project/concerns.yaml,tools/concerns-schema.py); tier=2 
