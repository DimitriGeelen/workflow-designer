---
id: T-462
name: "G-037 second axis: agent-side recursive grep skips gitignored paths, and focus.yaml
  is one of them"
description: >
  G-037 second axis: agent-side recursive grep skips gitignored paths, and focus.yaml
  is one of them
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:23Z'
    ...
    rationale: blast_radius=5 
      (paths:.context/project/concerns.yaml,.context/working/focus.yaml,.context/working/session.yaml,tools/_t352-p011-errexit-probe.sh);
  ...
  - ts: '2026-08-16T13:58:56Z'
    ...
    rationale: blast_radius=3 
      (paths:.context/project/concerns.yaml,.context/working/focus.yaml,.context/working/session.yaml);
      tier=2 (no-signal); effort=8 (no-signal)
    rubric_sha: e4a00f38e801
---
