---
id: T-664
name: "Approvals queue has one representation for three states — never-looked-at,
  deferred, genuinely-waiting — so 61 unticked boxes all read as blockers"
description: >
  Approvals queue has one representation for three states — never-looked-at, deferred,
  genuinely-waiting — so 61 unticked boxes all read as blockers
...
cost_estimate_proposed:
  - ts: '2026-09-21T20:25:09Z'
    ...
    rationale: blast_radius=1 
      (paths:docs/reports/T-664-approvals-queue-has-no-agent-operable-outflow.md);
