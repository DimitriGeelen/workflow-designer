---
id: T-305
name: "Pre-flight the operator close path: verify-gate sweep of the 66 close-ready
  tasks, fix rotted Verification lines"
description: >
  Pre-flight the operator close path: verify-gate sweep of the 66 close-ready tasks,
  fix rotted Verification lines
...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T14:33:26Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=0 (no-signal); 
      ...
      (no-signal); F4=4 (prose:routing-structural); F3=0 (no-signal); F1=2 
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:20Z'
    ...
    rationale: blast_radius=5 
      (paths:.context/project/learnings.yaml,docs/reports/T-302-reviewer-sweep.md,tests/run-bridge-tests.sh,tools/_corpus-adopt-verify.py);
