---
id: T-437
name: "Record AEF's OBS-221 disposition on G-031 so the concern carries its upstream
  resolution"
description: >
  AEF accepted the 75/EX_TEMPFAIL remedy as specified at DM 541 and answered the block-vs-warn
  half: could-not-evaluate BLOCKS at the push gate. G-031 currently records only the
  finding. A concern that does not carry its upstream disposition is how a finding
  gets re-derived — the exact failure T-436 was filed about.
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:23Z'
    ...
    rationale: blast_radius=3 
      (paths:.context/project/concerns.yaml,tools/_t352-p011-errexit-probe.sh,tools/validate-workflow.py);
