...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T14:33:17Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=0 (no-signal); 
      ...
      (no-signal); F4=2 (prose:routing-single-element); F3=4 
      (prose:seam-fixture-or-pin); F1=2 (prose:process-editor-capability)
    rubric_sha: e4a00f38e801
...
### Human
- [x] [REVIEW] Deleting a workflow feels safe and clear
  **Steps:**
