---
id: T-547
name: "HX-Prompt rationale stored percent-encoded: server ignores htmx's URI-AutoEncoded
  companion header"
description: >
  HX-Prompt rationale stored percent-encoded: server ignores htmx's URI-AutoEncoded
  companion header
