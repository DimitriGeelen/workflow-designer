---
id: T-628
name: "G-020 block message names two escapes; both are refused by the gate that prints
  them"
description: >
  G-020 block message names two escapes; both are refused by the gate that prints
  them
...
cost_estimate_proposed:
  - ts: '2026-09-21T20:25:08Z'
    ...
    rationale: blast_radius=3 
      (paths:.agentic-framework/agents/context/check-active-task.sh,tools/_t386-drift-remedy-reachable.sh,tools/_t628-g020-remedy-reachable.sh);
