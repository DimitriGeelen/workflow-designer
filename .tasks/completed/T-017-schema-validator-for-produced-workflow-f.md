...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:14Z'
    ...
    rationale: blast_radius=5 
      (paths:docs/designer/schema.md,docs/reports/T-002-aef-workflow-designer-goals.md,tests/fixtures/valid/investigate.workflow.yaml,tests/run-validator-tests.sh);
