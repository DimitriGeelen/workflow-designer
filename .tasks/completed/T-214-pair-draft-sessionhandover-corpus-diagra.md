...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:18Z'
    ...
    rationale: blast_radius=3 
      (paths:tests/fixtures/aef-bpmn/arc-lifecycle.bpmn,tests/fixtures/aef-bpmn/session-handover.bpmn,tools/validate-workflow.py);
...
-->
- [x] [REVIEW] The session/handover diagram reads faithfully in the designer UI (the pair-draft review step)
  **Steps:**
