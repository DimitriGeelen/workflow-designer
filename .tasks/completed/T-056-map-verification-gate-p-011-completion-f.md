---
id: T-056
name: "Map verification-gate (P-011) completion flow"
description: >
  Diagram work-completed -> extract Verification cmds -> run each -> pass / block-on-nonzero
  / --force. CLAUDE.md Verification Gate. Dogfood gap (T-054).
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:15Z'
    ...
    rationale: blast_radius=5 
      (paths:.agentic-framework/agents/task-create/update-task.sh,docs/reports/T-056-verification-gate-friction.md,examples/aef-processes/verification-gate.workflow.yaml,tests/check-corpus-geometry.sh);
