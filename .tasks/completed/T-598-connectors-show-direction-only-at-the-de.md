---
id: T-598
name: "Connectors show direction only at the destination: add a smaller source-end
  arrow pointing toward the target"
description: >
  Connectors show direction only at the destination: add a smaller source-end arrow
...
cost_estimate_proposed:
  - ts: '2026-09-21T20:25:08Z'
    ...
    rationale: blast_radius=3 
      (paths:src/aef-workflow-designer.html,tools/_t598-source-marker.py); 
