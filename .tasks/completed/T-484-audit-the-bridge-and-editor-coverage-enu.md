...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:24Z'
    ...
    rationale: blast_radius=5 
      (paths:tools/_t352-p011-errexit-probe.sh,tools/_t484-coverage-list-behaviour-audit.py,tools/validate-workflow.py,tools/yaml-to-bpmn.py);
  ...
  - ts: '2026-08-16T13:58:56Z'
    ...
    rationale: blast_radius=3 
      (paths:tools/_t484-coverage-list-behaviour-audit.py,tools/yaml-to-bpmn.py);
      tier=2 (no-signal); effort=8 (no-signal)
    rubric_sha: e4a00f38e801
---
