...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:22Z'
    ...
    rationale: blast_radius=3 
      (paths:tools/_t352-p011-errexit-probe.sh,tools/_t373-defer-revisit-blindspot.sh,tools/validate-workflow.py);
  ...
  - ts: '2026-08-16T13:58:54Z'
    ...
    cost_estimate:
      ...
      effort: 8
      blast_radius: 1
    rationale: blast_radius=1 (paths:tools/_t373-defer-revisit-blindspot.sh); 
      tier=2 (no-signal); effort=8 (no-signal)
    rubric_sha: e4a00f38e801
---
