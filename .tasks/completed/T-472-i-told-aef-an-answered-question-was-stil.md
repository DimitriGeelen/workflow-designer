...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:23Z'
    ...
    rationale: blast_radius=5 
      (paths:.tasks/active/T-443-rename-fixturesaef-bpmn-as-a-v12-standar.md,.tasks/active/T-449-provenance-pair-draft-rows-are-two-sided.md,docs/reports/T-471-seam-repin-trigger-inventory.md,tools/_t352-p011-errexit-probe.sh);
