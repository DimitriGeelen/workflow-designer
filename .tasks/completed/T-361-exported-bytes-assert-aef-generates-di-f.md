---
id: T-361
name: "Exported bytes assert AEF generates DI from aef:position — AEF confirms they
  never have"
description: >
  Exported bytes assert AEF generates DI from aef:position — AEF confirms they never
  have
...
date_finished: 2026-08-03T21:48:05Z
...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T14:33:30Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=2 
      ...
      (prose:routing-engine); F3=4 (prose:seam-fixture-or-pin); F1=1 
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:21Z'
    ...
    rationale: blast_radius=7 
      (paths:src/aef-workflow-designer.html,tests/fixtures/aef-bpmn/resume-status.bpmn,tests/fixtures/exported/t361-trailer-witness.bpmn,tests/test_emitted_comment_claims.py);
...
- **Scan ID:** R-327af15c
- **Timestamp:** 2026-08-03T21:48:07Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none

### 2026-08-03T21:48:05Z — status-update [task-update-agent]
