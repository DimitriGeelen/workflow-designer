...
cost_estimate_proposed:
  - ts: '2026-09-21T20:25:08Z'
    ...
    rationale: blast_radius=5 
      (paths:.agentic-framework/agents/context/lib/safe-commands.sh,.agentic-framework/web/test_safe_commands.py,.context/inbox.yaml,tools/_t392-safelist-shadow-gate.py);
