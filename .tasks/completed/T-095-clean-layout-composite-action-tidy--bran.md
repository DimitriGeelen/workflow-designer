---
id: T-095
name: "Clean layout composite action: Tidy + branch pitch + align rows + reroute,
  one click, undoable"
description: >
  T-092 GO Phase A option 9: single-click Clean action composing Tidy + branch-pitch
  application (T-093) + align rows (T-094) + full reroute, as one undoable step. Depends
  on T-093 and T-094 landing first.
...
- [x] [REVIEW] One Clean click reads well end-to-end
  **Steps:**
...
test "$(grep -c 'cleanLayout()' src/aef-workflow-designer.html)" -ge 2  # was =2; call sites grew legitimately (T-099/T-100/T-125), T-305
