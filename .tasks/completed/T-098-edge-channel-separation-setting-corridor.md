...
description: >
  T-092 Phase B option 2: expose the T-097 corridor channel pitch (anchor spread +
  stub-rank channels for fan/join siblings) as a routing setting — off/0px, tight/4px,
  roomy/8px (default 8 = T-097 behaviour). Editor-local pref like straightening/attach
  mode; never stored in the document.
...
-->
- [x] [REVIEW] Channel separation control feels right on real maps
  **Steps:**
