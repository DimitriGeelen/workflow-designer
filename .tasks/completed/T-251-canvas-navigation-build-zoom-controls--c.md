---
id: T-251
name: "Canvas navigation build: zoom controls + Ctrl+wheel + scrollbars + drag-to-pan
  (T-249 GO)"
description: >
  Canvas navigation build: zoom controls + Ctrl+wheel + scrollbars + drag-to-pan (T-249
  GO)
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:19Z'
    ...
    rationale: blast_radius=7 
      (paths:docs/reports/T-249-canvas-navigation.md,src/aef-workflow-designer.html,tests/check-corpus-geometry.sh,tests/run-bridge-tests.sh);
