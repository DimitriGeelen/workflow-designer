...
description: >
  ...
  can't be clicked/selected — likely the T-133 r11 endpoint halo shadowing sibling
  edges.
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:16Z'
    ...
    rationale: blast_radius=3 
      (paths:build/gallery/designer.html,src/aef-workflow-designer.html,tools/_endpoint-overlap-verify-cdp.mjs);
...
### Human
- [x] [REVIEW] At a fork/join, clicking between the converging lines now reliably selects the one
