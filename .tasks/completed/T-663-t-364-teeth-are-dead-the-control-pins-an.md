---
id: T-663
name: "T-364 teeth are dead: the control pins an emitter baseline 22 commits old,
  so _t308 unusable:0 is an unproven zero again"
description: >
  T-364 teeth are dead: the control pins an emitter baseline 22 commits old, so _t308
  unusable:0 is an unproven zero again
...
cost_estimate_proposed:
  - ts: '2026-09-21T20:25:09Z'
    ...
    rationale: blast_radius=5 
      (paths:tests/run-bridge-tests.sh,tools/_t308-export-byte-identity-cdp.mjs,tools/_t364-t308-teeth.py,tools/_t509-instrument-sweep.sh);
