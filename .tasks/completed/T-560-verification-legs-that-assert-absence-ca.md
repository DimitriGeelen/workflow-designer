---
id: T-560
name: "Verification legs that assert ABSENCE cannot distinguish a satisfied assertion
  from a broken pattern (OBS-297)"
description: >
  Verification legs that assert ABSENCE cannot distinguish a satisfied assertion from
  a broken pattern (OBS-297)
...
cost_estimate_proposed:
  - ts: '2026-09-21T20:25:07Z'
    ...
    rationale: blast_radius=5 
      (paths:.context/episodic/T-001.yaml,tests/run-bridge-tests.sh,tools/_t560-absence-assertion-census.py,tools/_t560-absence-census-teeth.py);
