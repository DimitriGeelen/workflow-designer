...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:14Z'
    ...
    rationale: blast_radius=7 
      (paths:.agentic-framework/lib/promote.sh,docs/reports/T-045-promotion-friction.md,examples/aef-processes/promotion-pipeline.workflow.yaml,examples/aef-processes/rendered/promotion-pipeline.bpmn);
