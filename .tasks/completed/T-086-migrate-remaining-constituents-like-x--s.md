...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T14:33:11Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=0 (no-signal); 
      ...
      (prose:routing-structural); F3=2 (prose:seam-namespace); F1=1 
...
grep -q 'x-checks:\|x-sources:\|x-captures:\|x-gates:' .tasks/completed/T-081-subprocess-node-type-phase-1-collapsed-o.md
