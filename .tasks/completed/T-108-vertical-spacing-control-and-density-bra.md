...
description: >
  Operator report: Density and Branch-pitch settings appear ineffective; add a working
  vertical-spacing control and decide their fate. See task body.
...
### Human
- [x] [REVIEW] The vertical-spacing control visibly adjusts row spacing, and no ineffective control remains
  **Steps:**
...
grep -q 'viewPrefs.density\|set-density\|DENSITY_PITCH' .context/episodic/T-085.yaml
