---
id: T-007
name: "fw init seeds patterns.yaml with origin_task field but template expects learned_from"
description: >
  Inception: fw init seeds patterns.yaml with origin_task field but template expects
  learned_from
