---
id: T-480
name: "Project aef:endpoint in the round-trip semantic fixed point so a future drop
  cannot be silent"
description: >
  Project aef:endpoint in the round-trip semantic fixed point so a future drop cannot
  be silent
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:24Z'
    ...
    rationale: blast_radius=5 
      (paths:docs/reports/T-357-di-adoption.md,tests/test_roundtrip_serialization.py,tools/_roundtrip-serialization-cdp.mjs,tools/_t352-p011-errexit-probe.sh);
  ...
  - ts: '2026-08-16T13:58:56Z'
    ...
    rationale: blast_radius=3 
      (paths:docs/reports/T-357-di-adoption.md,tests/test_roundtrip_serialization.py,tools/_roundtrip-serialization-cdp.mjs);
      tier=2 (no-signal); effort=8 (no-signal)
    rubric_sha: e4a00f38e801
---
