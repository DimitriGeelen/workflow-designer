---
id: T-607
name: "Focus-drift gate cannot see the fw invocation form CLAUDE.md mandates: path-prefixed
  bin/fw escapes patterns 1 and 2"
description: >
  Focus-drift gate cannot see the fw invocation form CLAUDE.md mandates: path-prefixed
  bin/fw escapes patterns 1 and 2
...
cost_estimate_proposed:
  - ts: '2026-09-21T20:25:08Z'
    ...
    cost_estimate:
      ...
      effort: 8
      blast_radius: 1
    rationale: blast_radius=1 (paths:tools/_t607-drift-gate-reach.py); tier=2 
