---
id: T-531
name: "determine the direction of the termlink identity merge on agent-chat-arc: both projects now post under one sender_id and AEF asks which end re-keyed"
description: >
  determine the direction of the termlink identity merge on agent-chat-arc: both projects now post under one sender_id and AEF asks which end re-keyed
...
last_update: 2026-08-15T21:59:43Z
