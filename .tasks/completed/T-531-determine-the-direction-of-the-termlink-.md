...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:25Z'
    ...
    rationale: blast_radius=3 
      (paths:.agentic-framework/lib/templates/scripts/agent-conversation-status.sh,tools/_t352-p011-errexit-probe.sh,tools/validate-workflow.py);
  ...
  - ts: '2026-08-16T13:58:58Z'
    ...
    rationale: blast_radius=1 
      (paths:.agentic-framework/lib/templates/scripts/agent-conversation-status.sh);
      tier=2 (no-signal); effort=8 (no-signal)
    rubric_sha: e4a00f38e801
---
