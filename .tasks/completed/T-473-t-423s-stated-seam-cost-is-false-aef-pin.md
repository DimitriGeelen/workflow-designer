...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:23Z'
    ...
    rationale: blast_radius=5 
      (paths:.tasks/active/T-340-standard-bpmn-di-is-silently-discarded-o.md,.tasks/active/T-423-t-357-step-2-emit-bpmn-di-additively-alo.md,tests/run-bridge-tests.sh,tools/_t352-p011-errexit-probe.sh);
  ...
  - ts: '2026-08-16T13:58:56Z'
    ...
    rationale: blast_radius=3 
      (paths:.tasks/active/T-340-standard-bpmn-di-is-silently-discarded-o.md,.tasks/active/T-423-t-357-step-2-emit-bpmn-di-additively-alo.md,tests/run-bridge-tests.sh);
      tier=2 (no-signal); effort=8 (no-signal)
    rubric_sha: e4a00f38e801
---
