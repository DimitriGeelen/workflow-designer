---
id: T-633
name: "Shared /tmp sinks: we are on the same host as both peers and we run as root,
  so ownership cannot identify a writer"
description: >
  Shared /tmp sinks: we are on the same host as both peers and we run as root, so
  ownership cannot identify a writer
...
cost_estimate_proposed:
  - ts: '2026-09-21T20:25:08Z'
    ...
    rationale: blast_radius=3 
      (paths:tools/_t631-tier0-approval-reachable.sh,tools/_t633-shared-tmp-sinks.sh,tools/check-vacuous-verification.py);
