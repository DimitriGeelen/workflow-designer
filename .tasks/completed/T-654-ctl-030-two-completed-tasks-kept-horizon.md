---
id: T-654
name: "CTL-030: two completed tasks kept horizon:now and got no episodic — find the
  finalization path that skipped both"
description: >
  CTL-030: two completed tasks kept horizon:now and got no episodic — find the finalization
  path that skipped both
...
cost_estimate_proposed:
  - ts: '2026-09-21T20:25:08Z'
    ...
    rationale: blast_radius=5 
      (paths:.agentic-framework/.vendor-divergence.yaml,.context/episodic/T-542.yaml,.context/episodic/T-574.yaml,tools/_t654-archiving-a-partial-complete-task-must-null-its-horizon.sh);
