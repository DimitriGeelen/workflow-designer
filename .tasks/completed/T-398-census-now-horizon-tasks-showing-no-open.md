...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:22Z'
    ...
    rationale: blast_radius=5 
      (paths:.agentic-framework/agents/task-create/update-task.sh,.context/project/concerns.yaml,build/gallery/designer.html,tools/_t352-p011-errexit-probe.sh);
  ...
  - ts: '2026-08-16T13:58:54Z'
    ...
    rationale: blast_radius=3 
      (paths:.agentic-framework/agents/task-create/update-task.sh,.context/project/concerns.yaml,build/gallery/designer.html);
      tier=2 (no-signal); effort=8 (no-signal)
    rubric_sha: e4a00f38e801
---
