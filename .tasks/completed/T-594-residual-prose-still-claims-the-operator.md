---
id: T-594
name: "Residual prose still claims the operator resolved H2 after T-593 cleaned the
  structured fields"
description: >
  Residual prose still claims the operator resolved H2 after T-593 cleaned the structured
  fields
...
cost_estimate_proposed:
  - ts: '2026-09-21T20:25:08Z'
    ...
    rationale: blast_radius=3 
      (paths:.tasks/active/T-590-ewcr-arc-0-designer-contract-inventory-a.md,docs/research/executable-workflow/handoff-ewcr-v1-designer-fixture.yaml,tools/_t594-prose-claim-teeth.sh);
