---
id: T-287
name: "Pre-validate AEF pair-draft seeds (dispatch-loop-relabel + tier0-escalation)
  and reply findings"
description: >
  Pre-validate AEF pair-draft seeds (dispatch-loop-relabel + tier0-escalation) and
  reply findings
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:20Z'
    ...
    rationale: blast_radius=3 
      (paths:examples/aef-processes/rendered/tier0-escalation.bpmn,tools/validate-workflow.py);
  ...
  - ts: '2026-08-16T13:58:52Z'
    ...
    rationale: blast_radius=1 
      (paths:examples/aef-processes/rendered/tier0-escalation.bpmn); tier=2 
