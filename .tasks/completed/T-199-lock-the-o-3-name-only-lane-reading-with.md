...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T14:33:19Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=2 
      ...
      F3=4 (prose:seam-fixture-or-pin); F1=3 (prose:process-conformance)
    rubric_sha: e4a00f38e801
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:18Z'
    ...
    rationale: blast_radius=5 
      (paths:tests/test_forward_fixtures.py,tests/test_mapping_standard_conformance.py,tests/test_validate_iw9.py,tools/validate-workflow.py);
  ...
  - ts: '2026-08-16T13:58:50Z'
    ...
    rationale: blast_radius=3 
      (paths:tests/test_forward_fixtures.py,tests/test_mapping_standard_conformance.py,tests/test_validate_iw9.py);
      tier=2 (no-signal); effort=8 (no-signal)
    rubric_sha: e4a00f38e801
---
