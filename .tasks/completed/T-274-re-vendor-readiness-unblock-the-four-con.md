---
id: T-274
name: "Re-vendor readiness: unblock the four-concern closure path (upstream coordinates
  + operator procedure)"
description: >
  Re-vendor readiness: unblock the four-concern closure path (upstream coordinates
  + operator procedure)
