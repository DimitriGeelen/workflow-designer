...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T14:33:18Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=0 (no-signal); D3=0 (no-signal); 
      ...
      (prose:seam-contract); F1=3 (prose:process-conformance)
    rubric_sha: e4a00f38e801
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:18Z'
    ...
    rationale: blast_radius=5 
      (paths:src/aef-workflow-designer.html,tests/test_roundtrip_serialization.py,tools/_roundtrip-serialization-cdp.mjs,tools/yaml-to-bpmn.py);
