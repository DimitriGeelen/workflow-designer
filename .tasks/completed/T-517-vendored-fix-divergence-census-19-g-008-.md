---
id: T-517
name: "vendored-fix divergence census: 19 G-008 in-tree framework fixes a re-vendor
  would silently clobber"
description: >
  vendored-fix divergence census: 19 G-008 in-tree framework fixes a re-vendor would
  silently clobber
...
bvp_scores_proposed:
  ...
  - ts: '2026-08-16T14:33:44Z'
    ...
    rationale: D1=4 (body:structural-gate); D2=4 (body:fw-audit-or-doctor); D3=0
      ...
      (no-signal); F4=0 (no-signal); F3=3 (prose:seam-consumer-defect); F1=1 
