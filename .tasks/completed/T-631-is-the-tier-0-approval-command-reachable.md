---
id: T-631
name: "Is the Tier-0 approval command reachable while Tier 0 is blocking, or does
  the gate refuse its own approval route"
description: >
  Is the Tier-0 approval command reachable while Tier 0 is blocking, or does the gate
  refuse its own approval route
...
cost_estimate_proposed:
  - ts: '2026-09-21T20:25:08Z'
    ...
    rationale: blast_radius=5 
      (paths:tools/_t386-drift-remedy-reachable.sh,tools/_t628-g020-remedy-reachable.sh,tools/_t629-g067-remedy-reachable.sh,tools/_t630-p011-stdin-swallow.sh);
