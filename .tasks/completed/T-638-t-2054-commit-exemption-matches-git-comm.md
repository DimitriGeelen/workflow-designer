---
id: T-638
name: "T-2054 commit exemption matches git commit anywhere, so a compound command
  carries its other clauses past the active-task gate"
description: >
  T-2054 commit exemption matches git commit anywhere, so a compound command carries
  its other clauses past the active-task gate
...
cost_estimate_proposed:
  - ts: '2026-09-21T20:25:08Z'
    ...
    rationale: blast_radius=3 
      (paths:.agentic-framework/web/test_safe_commands.py,tools/_t638-commit-exemption-is-clause-scoped.sh);
