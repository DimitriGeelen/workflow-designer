---
id: T-525
name: "the fabric coverage WARN reports a raw count that rises while coverage improves,
  and cannot distinguish source growth from card deletion"
description: >
  the fabric coverage WARN reports a raw count that rises while coverage improves,
  and cannot distinguish source growth from card deletion
...
cost_estimate_proposed:
  - ts: '2026-08-16T13:57:25Z'
    ...
    rationale: blast_radius=7 
      (paths:.agentic-framework/.vendor-divergence.yaml,.fabric/components/tools-_t525-fabric-coverage-teeth.yaml,tests/run-bridge-tests.sh,tools/_t352-p011-errexit-probe.sh);
  ...
  - ts: '2026-08-16T13:58:58Z'
    ...
    rationale: blast_radius=5 
      (paths:.agentic-framework/.vendor-divergence.yaml,.fabric/components/tools-_t525-fabric-coverage-teeth.yaml,tests/run-bridge-tests.sh,tools/_t517-vendor-divergence-teeth.py);
      tier=2 (no-signal); effort=8 (no-signal)
    rubric_sha: e4a00f38e801
---
